...
const button = tv({
  base: [
    'rounded-lg px-4 py-2 text-sm font-sm font-semibold outline-none shadow-sm',
  ...
  variants: {
    variant: {
      ...
      ghost:
        'rounded-md px-2 hover:bg-zinc-50 shadow-none text-zinc-500 dark:hover:bg-white/5 dark:text-zinc-100',
    },
  },
